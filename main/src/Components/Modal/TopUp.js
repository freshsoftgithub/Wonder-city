...
export function TopUpButton(){
    ...
    const toggleTopUp = () => {
        if(localStorage.getItem('cardID') === '-'){
            toast.warn("Карта не привязана, привяжите ее в профиле.",{
                position:"top-center"
              })
        } else {
            setTopUp(!topUp);
    ...
    function handleSubmit(e){
        ...
        const pay = ()=> {
            fetch('https://127.0.0.1:8443/TopUp',{method: 'POST', body:formData, mode: 'cors'})
            .then(res => {
                if(res.redirected){
            ...
            <div className="pay">
                ...
                <div className="pay-content">
                    ...
                    <form action="" method="post" onSubmit={handleSubmit}>
                        ...
                        <input className="pay-cardID" placeholder="Номер карты" value={cardID} 
                        readOnly="true" style={{backgroundColor: "#9e9d9dcc"}}></input>
